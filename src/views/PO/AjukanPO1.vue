            ...
            <div class="col-lg-12">
                ...
                <div class="row mb-4">
                    <div class="col-4">
                        ...
                        <select @change="triggerChange()" v-model="input.company"
                            class="form-select form-select-md mb-3" aria-label=".form-select-lg example">
                            <option v-for='company in g$listCompanyBelow' v-bind:value="company.id_company">{{
                                    company.name
                            }}
                            </option>
                        </select>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-3 mt-3">
                                            <argon-button color="primary" class="me-3"
                                                @click="triggerEditQuantity(item.order_number)">
                                                Edit
                                            </argon-button>
