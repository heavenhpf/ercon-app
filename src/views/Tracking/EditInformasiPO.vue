        ...
        <div class="card">
            <div class="card-body p-4">
                ...
                <div class="p-1">
                    ...
                    <p class="text-dark text-sm">{{ g$get_po_detail.d_order?.d_item.desc }}</p>
                </div>
                <hr>
                <div class="p-1 col-12">
                    <h6 class="text-dark mb-2">Informasi untuk Pemesan:</h6>
                ...
                <hr>
                <div class="p-1 col-12">
                    <h6 class="text-dark mb-2">Nomor PO Terkait (Opsional):</h6>
