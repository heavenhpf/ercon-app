<template>
  <div class="collapse zindex-0 navbar-collapse w-auto h-auto h-100" id="sidenav-collapse-main">
    <ul class="navbar-nav ">
      ...
      <li class="nav-item">
        <sidenav-item url="/po/ajukan-po" :class="getRoute() === 'ajukan-po' ? 'active' : ''"
          navText="Ajukan PO">
          <template v-slot:icon>
      ...
      <li class="nav-item">
        <sidenav-item url="/akun/company-saya" :class="getRoute() === 'company-saya' ? 'active' : ''" navText="Perusahaan Saya">
          <template v-slot:icon>
