<template>
    ...
    <ul class="px-2 py-3 dropdown-menu dropdown-menu-end me-n4" :class="showMenu ? 'show' : ''"
        ...
        <li class="mb-2 d-lg-block d-md-block d-sm-block d-none" v-for="data in g$listNotification">
        ...
        <li class="mb-2 d-lg-none d-md-none d-sm-none d-block" v-for="data in g$listNotification">
            <a class="dropdown-item border-radius-md" href="javascript:;">
                <div class="py-1 d-flex">
                    <div class="my-auto me-3" v-if="data.d_notification_object.entity_type === 1">
                        <i class="fas fa-cart-plus text-xs text-success cursor-pointer"></i>
                    </div>
                    <div class="my-auto me-3" v-if="data.d_notification_object.entity_type === 2">
                        <i class="fas fa-envelope-open text-xs text-info cursor-pointer"></i>
                    </div>
                    <div class="d-flex flex-column justify-content-center">
